...
import org.alikhan.apiprojects.messenger.exception.DataNotFoundException;
...
public class MessageService {
	...
	public MessageService() {
		messages.put(1L, new Message(1, "Hello World!", "Ali Khan"));
		messages.put(2L, new Message(2, "Hello Jersey!", "Sandeep"));
		messages.put(3L, new Message(3, "Hello Kiran!", "Kiran"));
		messages.put(4L, new Message(4, "Hello Sunil!", "Sunil"));
