...
import org.alikhan.apiprojects.messenger.service.CommentService;

@Path("/") //This is optional for subresource
...
//						) {
//		return "Method to return message id: " + messageId + ", comment id: " + commentId;
//	}
